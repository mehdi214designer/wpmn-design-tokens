...
## Output format
A single self-contained `<section class="wpmn-sec-testimonial-drag-carousel">` with scoped `<style>`, markup, and a scoped IIFE resolving root via `document.currentScript.parentElement`. Sub-classes/keyframes section-prefixed.
